  ...
  return (
    <AppShell>
      <header className="mb-7">
        <Link href="/" className="text-xs text-muted-2 hover:text-gold">
          ← Каталог
        </Link>
        <h1 className="mt-2 font-display text-4xl font-semibold">{course.title}</h1>
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted">{course.description}</p>
        ...
        {course.hasAccess ? (
          ...
          <div className="mt-5 inline-block rounded-xl border border-line px-5 py-3 text-sm text-muted-2">
